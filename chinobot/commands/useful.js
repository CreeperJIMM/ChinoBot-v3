...
module.exports = {
    "hi": {
        ...
        fun: function (bot, message, clientDB, language, args, ...ag) {
            ...
            if (language === "zh_TW") { lang = lan.zh_TW; useful2 = useful.zh_TW } else if (language === "zh_CN") { lang = lan.zh_CN; useful2 = useful.zh_CN } else if (language === "ja_JP") {
                lang = lan.ja_JP; useful2 = useful.ja_JP
        ...
        fun: function (bot, message, clientDB, language, args, ...ag) {
            ...
            if (message.member.permissions.has(['MANAGE_CHANNELS']) || message.author.id === "546144403958398988") {
                ...
                message.channel.createWebhook(message.author.username, {
                    ...
                    reason: 'Speak in' + message.channel.name + ' by ' + message.author.username
                }).then((hook) => {
