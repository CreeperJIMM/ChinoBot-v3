...
module.exports = {
    ...
    "help": {
        ...
        fun: function (client, interaction, prefix, clientDB, userlang, args, ag) {
            ...
            if (language === "zh_TW") { lang = lan.zh_TW; h = helpX.zh_TW } else if (language === "zh_CN") { lang = lan.zh_CN; h = helpX.zh_CN } else if (language === "ja_JP") {
                lang = lan.ja_JP; h = helpX.ja_JP
    ...
    "snipe": {
        ...
        fun: function (client, interaction, p, clientDB, userlang, args, ag) {
            ...
            if (userlang === "zh_TW") { l = lan.zh_TW; k = guildX.zh_TW } else if (userlang === "zh_CN") { l = lan.zh_CN; k = guildX.zh_CN } else if (userlang === "ja_JP") {
                l = lan.ja_JP; k = guildX.ja_JP
